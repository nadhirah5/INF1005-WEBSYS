    ...
    if (!isset($_SESSION['cart_items'])) {
        ...
        $_SESSION['cart_items'] = array(
            array(
                ...
                'quantityPickles' => $quantityPickles,
                'quantityTomatoes' => $quantityTomatoes,
                'quantityOnions' => $quantityOnions
            )
        );
    } else {
        ...
        foreach ($_SESSION['cart_items'] as $index => $cartItem) {
            if ($cartItem['foodName'] === $foodName) {
                ...
                $_SESSION['cart_items'][$index]['quantityPickles'] += $quantityPickles;
                $_SESSION['cart_items'][$index]['quantityTomatoes'] += $quantityTomatoes;
                $_SESSION['cart_items'][$index]['quantityOnions'] += $quantityOnions;
                $itemExists = true;
                break;
            }
        }
