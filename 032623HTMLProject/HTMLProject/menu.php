            ...
            <section class="dishes" id="menu">
                ...
                <h1 class="heading">desert</h1>
                    ...
                    function displayFormFood($imagePath, $foodName, $foodPrice) {
                        return '
                            <div id="myFormFood">
                                <form method="post" action="cart.php" id="myFormFoodID">
                                    ...
                                    <input type="text" name="foodName" id=foodName" required value="' . $foodName . '">
                                    <input type="text" name="foodPrice" id=foodPrice" required value="' . $foodPrice . '">
                ...
                <script>
                    ...
                    function displayFormFood(imagePath, foodName, foodPrice) {
                        ...
                        function displayFormDrink(imagePath, foodName, foodPrice) {
                            ...
                            form2.action="process_addtocart";
