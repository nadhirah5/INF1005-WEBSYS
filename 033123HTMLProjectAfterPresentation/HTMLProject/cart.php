...
//                                "<td data-th='Onion'>" . $quantityOnions . "</td>" .
                                ...
                                "<td data-th='removeitem'>" .
                                "<form method='POST'>" .
                                "<input type='hidden' name='foodName' value='" . $foodName . "'>" .
                                "<input type='submit' name='deleteItem' class='btn' value='Delete item'>" .
                                "</form>" .
                                "</td>" .
                                "</tr>";
                            }
                            ...
                            if (isset($_POST['deleteItem'])) {
                                ...
                                foreach ($_SESSION['cart_items'] as $key => $cartItem) {
                                    if ($foodName == $cartItem['foodName']) {
                                        unset($_SESSION['cart_items'][$key]);
                                        echo '<script>window.location.reload()</script>'; // reload the page
                                        exit; // exit the script to make sure the reload happens
                                    }
                                }
