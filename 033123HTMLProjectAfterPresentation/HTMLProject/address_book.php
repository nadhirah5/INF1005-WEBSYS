...
//                
            ...
            global $primarypostal, $primarystreet;
            if (isset($_POST['deleteAddress'])) {

                
//                echo "<h1 class='heading'>".$_POST['customeraddress']."</h1>";
//                echo "<h1 class='heading'>".$primarystreet."</h1>";
//                echo "<h1 class='heading'>".$_POST['customerpostal']."</h1>";
//                echo "<h1 class='heading'>".$primarypostal."</h1>";
                if ($_POST['customeraddress'] == $address && $_POST['customerpostal'] == $postalcode) {
                    echo "<h3 class='sub-heading'>Cannot delete Primary address</h3>";
                } else {
                    deleteAddress();
                }
            }
                ...
                <form method="post" id="addAddress-form">
                    ...
                    <div class="inputBox">
                        <div class="input">
                            ...
                            <input type="text" name="postalcode" pattern="[0-9]{6}" id="postalcode" required placeholder="111111">
                        </div>
                    </div>
