                ...
                <form method="POST" id="register-form">
                    ...
                    <div class="inputBox">
                        <div class="input">
                            ...
                            <input type="text" name="fname" id="fname" required placeholder="Tony">
                        </div>
                    ...
                    <div class="inputBox">
                        <div class="input">
                            <span>Last Name</span>
                            <input type="text" name="lname" id="lname"  placeholder="Tan">
                        </div>
                    ...
                    <div class="inputBox">
                        <div class="input">
                            ...
                            <input type="date" id="dob" name="dob" required value="2023-03-07" min="1900-01-01" max="2007-01-01">
                        </div>
                    </div>
                    ...
                    <div class="inputBox">
                        <div class="input">
                            ...
                            <input type="text"  pattern="[0-9]{6}" name="postalcode" id="postalcode" required placeholder="111111" min="6" max="6">
                        </div>
                    </div>
