...
function sanitize_money($data) {
    ...
    $foodName = sanitize_input($_POST['desertName']);
    $foodPrice = sanitize_money($_POST['desertPrice']);
    $desertQuantity = sanitize_menu($_POST['desertQuantity']);
    $request = "None";
    ...
    if (!isset($_SESSION['cart_items'])) {
        ...
        foreach ($_SESSION['cart_items'] as $index => $cartItem) {
            if ($cartItem['foodName'] === $foodName && $cartItem['request'] === $request) {
                ...
                $_SESSION['cart_items'][$index]['foodQuantity'] += $desertQuantity;     
                $itemExists = true;
                break;
            }
        }
