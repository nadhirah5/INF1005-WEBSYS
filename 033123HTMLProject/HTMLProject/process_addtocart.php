...
<html lang="en">
    ...
    <body>
        ...
        $foodName = sanitize_input($_POST['foodName']);
        $foodPrice = sanitize_money($_POST['foodPrice']);
        $foodQuantity = sanitize_menu($_POST['foodQuantity']);
        $quantityPickles = sanitize_menu($_POST['quantityPickles']);
        $quantityTomatoes = sanitize_menu($_POST['quantityTomatoes']);
        $quantityOnions = sanitize_menu($_POST['quantityOnions']);
