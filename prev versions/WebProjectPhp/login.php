...
<html>
    ...
    <body>
        ...
        <p class=" d-flex pb-4 justify-content-center">Don't have an account? &nbsp; <a href='register.php'>Register now!</a></p>
        <section>
            <form action="process_login.php" method="post">
                <div class=" d-flex pb-4 justify-content-center">
                    <label class="col-sm-2 pr-5 text-right" for="email">Email:</label>
